...
# 1: Examine price correlation in geographically close markets.
...
# 2: Calculate market variability
...
# 3: Determine an influential market.
...
# 4: Correlation across most traded crops
def CropCorrelation ():
